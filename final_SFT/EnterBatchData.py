...
import base64
'''
This is the class for enter the data of full bach at onece of the system. It verify the username and password by using config text file.
It read and write to the system database which indicate the password and username in the text files
'''
#--------------------------------------
Er="null"
class Example():
    def onError(self):
        box.showerror("Error", "Could not Update")

    def onQuest(self):
        box.askquestion("Question", "Are you sure to quit?")

    def onInfo(self):
        box.showinfo("Information", "Update Successfully")
