...
def plot():
    ...
    pl.plot(xv, val,'b')
    y=[30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30]
    pl.plot(yv,'r')
...
def WritePred(student,fVal,code):
    ...
    sql1 = "UPDATE %s SET pred = '%d' WHERE StudentName = '%s'" % (code,int(fVal),student)
    try:
