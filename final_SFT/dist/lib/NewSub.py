...
import os
'''
This is the class for Enter new subject to the database.
Password of the database is read from the file
write data to the file
NewStudentIndex.txt file should contained the inedex numbers of sutdent
'''
...
class Example():
    ...
    def onInfo(self):
        box.showinfo("Information", "Created Sucessfully")
    def onInfo2(self):
        box.showinfo("Information", "Sucessfully Inserted")
...
class NewSub():
    ...
    def CreatTable(cls,tbl):
        ...
        cls.db = MySQLdb.connect("localhost",cls.user,cls.pas,"marks" )
    ...
    def ScanNames(cls,Tbl):
        ...
        names=cls.ReadNames()
        for x in names:
            cls.sql1="INSERT INTO %s "%(str(Tbl))+"(StudentName, Test1, Test2, Test3, Test4, Test5, Test6,Test7, Test8, Test9, Test10,Test11, Test12,Test13, Test14, Test15, pred) VALUES ('%s',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL)"%(str(x))
            try:
               # Execute the SQL command
