...
def helloCallBack3():
    os.system('python HomeWindow.py')
    root.quit()
...
button6 = tk.Button(panel1,width=20,borderwidth=5,foreground="dark red",text='Help',command= helloCallBack7)
button6.pack(side=BOTTOM,pady=5)
button6 = tk.Button(panel1,width=20,borderwidth=5,foreground="dark red", text='Exit App',command=root.quit())
button6.pack(side=BOTTOM,pady=5)
